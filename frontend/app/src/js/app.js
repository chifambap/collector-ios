...
import { initAuth, setAuthCallbacks, hideOfflineIndicator } from './auth.js';
...
setDrawCreatedCallback(() => {
  showPanel('collect');
  import('./utils.js').then(({ toast }) => toast('Field drawn — fill in the details and save', 'inf'));
});
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (auth.isLoggedIn()) { loadMBTilesList(); loadOverlaysList(); loadSurveys(); updateRoleUI(); }
