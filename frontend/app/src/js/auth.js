...
export function handleBiometricPlaceholder(e) {
  e.preventDefault();
  toast('Biometric unlock will be available in a future update — use PIN for now.', 'inf');
}
...
window.handleBiometricPlaceholder = handleBiometricPlaceholder;
