...
/** App PIN lock: no re-prompt within this window after successful unlock (ms). */
export const LOCAL_LOCK_GRACE_MS = 10 * 60 * 1000;

/**
 * Entries per /api/sync/push/ request. Must stay at or below the server's
 * SYNC_PUSH_MAX_ENTRIES (capacity-derived, floor 200) or batches are rejected
 * with 413.
 */
...
export const CROP_COLORS = {
  ...
  wheat: '#d4a017', barley: '#b8860b', pea: '#22c55e',
  blueberry: '#4f46e5', mango: '#ffb703', guava: '#86efac', coffee: '#6f4e37', lemon: '#e3e829', orange: '#fb923c', other_citrus: '#ffab5e', pasture_fodder: '#16a34a', fallow: '#bfa094', other_legumes: '#34d399', vegetables: '#fb7185', intercrop: '#14b8a6',
  other: '#64748b'
};
...
export const CROP_EMOJI = {
  ...
  wheat: '🌾', barley: '🌾', pea: '🫛',
  blueberry: '🫐', mango: '🥭', guava: '🍈', coffee: '☕', lemon: '🍋', orange: '🍊', other_citrus: '🌳', pasture_fodder: '🌱', fallow: '🟫', other_legumes: '🫛', vegetables: '🥕', intercrop: '🔀',
  other: '🌿'
};
